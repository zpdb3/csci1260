                    ...
                    switch(objOrPer){
                        case "barrel":
                            if(primaryCmnd.equalsIgnoreCase("look"))
                                ...
                                switch(secObjOrPer){
                                    case "barrel":
                                        currentStateOfThings.transferEquipment(currentStateOfThings.barrels.get(specificChoice),
                                                currentStateOfThings.barrls.get(secSpecificChoice));
                                        outPutString = "All items transferred from one barrel to the other.";
                                        break;
                                    case "chest":
                                        currentStateOfThings.transferEquipment(currentStateOfThings.barrels.get(specificChoice),
                                                currentStateOfThings.chests.get(secSpecificChoice));
                                ...
                                outPutString = "You attack the barrel doing " + currentStateOfThings.attack(currentStateOfThings.barrels.get(specificChoice)) +
                                               " damage.";
                            }
                        ...
                        case "chest":
                            if(primaryCmnd.equalsIgnoreCase("look"))
                                ...
                                switch(secObjOrPer){
                                    case "barrel":
                                        currentStateOfThings.transferEquipment(currentStateOfThings.chests.get(specificChoice),
                                                currentStateOfThings.barrls.get(secSpecificChoice));
                                ...
                                outPutString = "You attack the chest doing " + currentStateOfThings.attack(currentStateOfThings.chests.get(specificChoice)) +
                                        " damage.";
                            }
                            else if(primaryCmnd.equalsIgnoreCase("speak")){
                        ...
                        case "villager":
                            if(primaryCmnd.equalsIgnoreCase("look"))
                                outPutString = currentStateOfThings.getPersonInfo(currentStateOfThings.people.get(specificChoice));
                            else if(primaryCmnd.equalsIgnoreCase("use")) {
                                ...
                                switch(secObjOrPer){
                                    case "barrel":
                                        currentStateOfThings.transferEquipment(currentStateOfThings.people.get(specificChoice),
                                                currentStateOfThings.barrls.get(secSpecificChoice));
                                ...
                                outPutString = "You attack the villager doing " + currentStateOfThings.attack(currentStateOfThings.people.get(specificChoice)) +
                                        " damage.";
                            }
                            else if(primaryCmnd.equalsIgnoreCase("speak")){
                                outPutString = "You tell the person your hopes, dreams and deepest fears.\n" +
                                               "They reply:  " + currentStateOfThings.speakTo(currentStateOfThings.people.get(specificChoice));
                            }
                            break;
                        ...
                        case "goblin":
                            if(primaryCmnd.equalsIgnoreCase("look"))
                                ...
                                outPutString = "You attack the goblin doing " + currentStateOfThings.attack(currentStateOfThings.people.get(specificChoice)) +
                                        " damage.";
                            }
                            else if(primaryCmnd.equalsIgnoreCase("speak")){
